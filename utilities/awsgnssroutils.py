...
RODatabaseClient: 
    ...
    > occlist = rodb.inquire( missions="champ" )
    ...
    > occlist = rodb.inquire( datetimerange=("2019-06-01","2019-06-30") )
    ...
    RODatabaseClient.inquire or RODatabaseClient.restore, use the OccList.filter 
    method: 

    > champoccs = rodb.inquire( missions="champ" )
    ...
    > June2009 = rodb.inquire( datetimerange=("2009-06-01","2009-07-01") )
    ...
    > week_list = rodb.inquire( datetimerange=("2012-06-05","2012-06-12") )
...
#  Update the existing repository if requested. 
    ...
    def inquire(self, missions=None, receivers=None, transmitters=None,
        GNSSconstellations=None, longituderange=None, latituderange=None,
        datetimerange=None, localtimerange=None, geometry=None):
